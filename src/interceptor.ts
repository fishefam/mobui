...
function preparePage(
  ...
  document.documentElement.innerHTML = `
    ...
    <body>
        <div id="${rootLoaderElementId}" style="position:fixed;z-index:100;height:100vh;width:100vw;display:grid;place-items:center;">
            <style>
                html.light #${rootLoaderElementId} {
                  background: hsl(0 0% 100%);
                }
                html.dark #${rootLoaderElementId} {
